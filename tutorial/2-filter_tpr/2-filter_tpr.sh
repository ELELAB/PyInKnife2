...
# Set the name of the output TPR file
output_tpr=md_prot.tpr

# Run the 'convert-tpr' command to create a new TPR file containing
# only protein atoms
gmx_mpi convert-tpr -s $input_tpr -n $input_ndx -o $output_tpr
