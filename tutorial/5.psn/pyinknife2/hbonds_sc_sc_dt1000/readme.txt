...
#have only hbond mode set to true
#define the cutoffs to scrutinize
#if it is on the class all you can use the default - otherwise you need to add to the config the flag for the class
#check the compatibility with PyInteraph2 flags and file names

pyinknife_run  -f ../../../3.filt_trjs/traj_prot_dt1000.xtc -s pdbmovie_1.pdb -r pdbmovie_1.pdb -c run.yaml -d . -n 4
